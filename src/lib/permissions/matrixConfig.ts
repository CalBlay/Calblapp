...
export const PERMISSION_ACTION_GROUPS: PermissionActionGroup[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { key: PERM.action('/menu/calendar', 'event:cancel'), label: 'Cancel·lar o reactivar esdeveniments' },
      { key: PERM.action('/menu/calendar', 'attach:sharepoint'), label: 'Adjuntar documents (SharePoint)' },
      { key: PERM.action('/menu/calendar', 'documents:delete'), label: 'Eliminar documents adjunts' },
      { key: PERM.action('/menu/calendar', 'email:send-documents'), label: 'Enviar documents per correu' },
      { key: PERM.action('/menu/calendar', 'email:send-cancellation'), label: 'Enviar avisos de cancel·lació per correu' },
